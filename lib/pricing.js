...
export const DEFAULT_PRICING = [
  ...
  // 通义千问 Qwen3 系列（价格：美元/1M tokens）
  { pattern: 'qwen3*max*', input: 0.40, output: 1.20, label: 'Qwen3 Max' },
  { pattern: 'qwen3.8*', input: 0.40, output: 1.20, label: 'Qwen3.8' },
  { pattern: 'qwen3-72b*', input: 0.16, output: 0.32, label: 'Qwen3 72B' },
  { pattern: 'qwen3-32b*', input: 0.08, output: 0.16, label: 'Qwen3 32B' },
  { pattern: 'qwen3-14b*', input: 0.05, output: 0.10, label: 'Qwen3 14B' },
  { pattern: 'qwen3-8b*', input: 0.03, output: 0.06, label: 'Qwen3 8B' },
  { pattern: 'qwen-turbo*', input: 0.03, output: 0.06, label: 'Qwen Turbo' },
  { pattern: 'qwen-plus*', input: 0.08, output: 0.16, label: 'Qwen Plus' },
...
export function calculateCost(usage, model, pricingList) {
  ...
  const input_cost = (usage.input_tokens || 0) / 1000000 * pricing.input;
  const output_cost = (usage.output_tokens || 0) / 1000000 * pricing.output;
  return {
